...
test( 'isEmptyNode', function() {
    ...
    var domUtils = baidu.editor.dom.domUtils;
    div.innerHTML = '<div><b><i></i></b></div>';
    ok(true,domUtils.isEmptyNode(div));
...
test( 'isBr', function() {
    ...
    var div = te.dom[0];
    div.innerHTML = "<br>";
    ok(true,domUtils.isBr(div.firstChild));
} );
...
test( 'isFillChar', function() {
    ...
    ok(true,domUtils.isFillChar(div.innerHTML));
} );
...
test( 'isStartInblock', function() {
    ...
    ok(true,domUtils.isStartInblock(range));
...
test( 'isEmptyBlock', function() {
    ...
    var div = te.dom[0];
    domUtils.fillNode(document,div);
    ok(true,domUtils.isEmptyBlock(div));
    var span = document.createElement("span");
...
test( 'fillNode', function() {
    ...
    var div = te.dom[0];
    domUtils.fillNode(document,div);
    ok(true,div.innerHTML.length>0);
} );
