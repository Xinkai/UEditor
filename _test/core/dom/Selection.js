...
test( 'trace 1742  isFocus', function () {
    ...
    var editor1 =   new UE.Editor({'initialContent':'<span>hello</span>'});
    var editor2 =   new UE.Editor({'initialContent':'<span>hello</span>'});
    editor1.render(div1);
    editor2.render(div2);
    editor1.focus();
    ...
    var editor3 =   new UE.Editor({'initialContent':'<h1>hello</h1>'});
    var editor4 =   new UE.Editor({'initialContent':'<h1>hello</h1>'});
    editor3.render(div3);
    editor4.render(div4);
    editor3.focus();
