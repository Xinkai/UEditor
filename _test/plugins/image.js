...
test( '修改已有图片的属性', function () {
        ...
        var range = te.obj[1];
        var body = editor.body;
        editor.setContent( '<p><img src="http://img.baidu.com/hi/jx2/j_0004.gif" ><img src="http://img.baidu.com/hi/jx2/j_0053.gif" ></p>' );
        ...
        equal( ua.getChildHTML( body.firstChild ), '<img src="http://img.baidu.com/hi/jx2/j_0018.gif" data_ue_src=\"http://img.baidu.com/hi/jx2/j_0018.gif\"><img src="http://img.baidu.com/hi/jx2/j_0053.gif" data_ue_src=\"http://img.baidu.com/hi/jx2/j_0053.gif\">', '检查插入的图像地址' );
        equal( body.firstChild.childNodes.length, 2, '2个img孩子' );
} );
/*trace1491 修改动图的宽高*/
