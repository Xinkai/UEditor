...
test( '闭合情况h1套列表', function () {
    ...
    editor.execCommand( 'insertorderedlist' );
    equal( body.firstChild.tagName.toLowerCase(), 'ol', '仍然是ol' );
//    if ( baidu.editor.browser.webkit )
//        equal( ua.getChildHTML( body.firstChild ), '<li><h2>hello1<br></h2></li>', '查看插入列表后的结果' );
//    else
...
test( 'trace 1621:选中多重列表，设置为相同类型的列表', function () {
    ...
    var range = te.obj[1];
    var body = editor.body;
    editor.setContent( '<ol style="list-style-type:decimal; "><li><p>数字列表1</p></li><li><p>数字列表2</p></li></ol><ol style="list-style-type:lower-alpha; "><li><p>字母列表1</p></li><li><p>字母列表2</p></li></ol><ol style="list-style-type: upper-alpha; "><li><p>​大写字母1<br></p></li><li><p>大写字母2</p></li></ol>' );
    range.setStart( body, 1 ).setEnd( body.lastChild.firstChild, 1 ).select();
    var html = '<ol style="list-style-type:decimal; "><li><p>数字列表1</p></li><li><p>数字列表2</p></li></ol><ol style="list-style-type: upper-alpha; "><li><p>字母列表1</p></li><li><p>字母列表2</p></li><li><p>​大写字母1<br></p></li><li><p>大写字母2</p></li></ol>';
    editor.execCommand( 'insertorderedlist', 'upper-alpha' );
