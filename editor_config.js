...
(function () {
    ...
    var URL= window.UEDITOR_HOME_URL || window.location.pathname.replace(/_examples\/.*/,"");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    UEDITOR_CONFIG = {
	    ...
	    imageManagerPath:URL + "server/submit/imageManager.php",
        ...
        toolbars:[
            ['FullScreen', 'Source', '|', 'Undo', 'Redo', '|',
                ...
                'SelectAll', 'ClearDoc', 'SearchReplace','SnapScreen', 'Print', 'Preview', 'CheckImage', 'Attachment', 'Help','AutoTypeSet']
        ],
        ...
        labelMap:{
            ...
            'imageleft':'居左', 'imageright':'居右','attachment':'附件', 'imagecenter':'居中', 'checkimage':'图片转存',
        ...
        'li{clear:both}' +
        //设置段落间距
        'p{margin:5px 0;}li p{margin:5px 0\9}' +
        //清除表格浮动状态
        ...
        fullscrren : false, //是否上来就是全屏
        snapscreenHost: 'localhost', //屏幕截图的server端文件所在的网站名或者ip，请不要加http://
...
//                }
        ...
        autotypeset:{
            ...
            lineHeight : "100",            //段内间距 %单位 去掉这个属性表示不执行排版
            rowSpacing : "10",            //段间距，px单位 去掉这个属性表示不执行排版
